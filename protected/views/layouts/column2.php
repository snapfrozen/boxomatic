		...
		<nav class="top-bar" data-options="is_hover:true">
			...
			<ul class="right">
				...
				<li class='has-dropdown'>
					<a href="/index.php?r=customerPayment/enterPayments">Payments</a>
					<ul class="dropdown">
						<li><?php echo CHtml::link('Enter Payment',array('customerPayment/enterPayments')); ?></li>
					</ul>
				</li>
				<li class="divider"></li>
				...
				<li class="has-dropdown">
					...
					<ul class="dropdown">
						...
						<li><?php echo CHtml::link('Weeks',array('week/admin')); ?></li>
					</ul>
				</li>
