	...
	<div class="large-12 columns">
		<?php $this->widget('zii.widgets.CDetailView', array(
			...
			'attributes'=>array(
				...
				'value',
				'unit',
				array( 'name'=>'available_from', 'value'=>Yii::app()->snapFormat->getMonthName($model->available_from) ),
				array( 'name'=>'available_to', 'value'=>Yii::app()->snapFormat->getMonthName($model->available_to) ),
			),
		)); ?>
	</div>
</div>