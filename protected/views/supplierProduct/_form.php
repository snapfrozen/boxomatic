...
<fieldset>
	...
	<div class="row">
		...
		<div class="large-6 columns">
			<?php echo $form->labelEx($model,'packing_station_id'); ?>
			<?php echo $form->dropDownList($model,'packing_station_id', CHtml::listData(PackingStation::model()->findAll(), 'id', 'name')); ?>
			<?php echo $form->error($model,'packing_station_id'); ?>
		</div>
	</div>
	<?php endif; ?>
	...
	<div class="row">
		...
		<div class="large-4 columns">
			<?php echo $form->labelEx($model,'limited_stock'); ?> 
			<?php echo $form->checkBox($model,'limited_stock'); ?>   
			<?php echo $form->error($model,'limited_stock'); ?>
		</div>
	</div>
	...
	<div class="row">
		<div class="large-4 columns">
			...
			<?php else: ?>
				<?php echo CHtml::image($this->createUrl('supplierProduct/image')); ?>
			<?php endif; ?>
		</div>
