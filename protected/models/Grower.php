...
class Grower extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('grower_state, grower_website, grower_certification_status, grower_order_days, grower_produce, grower_notes, grower_payment_details', 'required'),
			...
			array('grower_order_days', 'length', 'max'=>255),
	...
	public function attributeLabels()
	{
		return array(
			...
			'grower_mobile' => 'Grower Mobile',
			'grower_phone' => 'Grower Phone',
			'grower_address' => 'Grower Address',
			'grower_address2' => 'Grower Address2',
			'grower_suburb' => 'Grower Suburb',
			'grower_state' => 'Grower State',
			'grower_postcode' => 'Grower Postcode',
			'grower_distance_kms' => 'Grower Distance Kms',
			'grower_bank_account_name' => 'Grower Bank Account Name',
			'grower_bank_bsb' => 'Grower Bank Bsb',
			'grower_bank_acc' => 'Grower Bank Acc',
			'grower_email' => 'Grower Email',
			'grower_website' => 'Grower Website',
			'grower_certification_status' => 'Grower Certification Status',
			'grower_order_days' => 'Grower Order Days',
			'grower_produce' => 'Grower Produce',
			'grower_notes' => 'Grower Notes',
			'grower_payment_details' => 'Grower Payment Details',
		);
	}
