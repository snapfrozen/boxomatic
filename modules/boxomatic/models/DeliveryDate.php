 ...
 */
class DeliveryDate extends BoxomaticActiveRecord
{
    ...
    {
        return $this->tablePrefix . 'delivery_dates';
    }
    ...
    public function relations()
    {
        ...
        return array(
            'MergedBoxes' => array(self::HAS_MANY, 'Box', 'delivery_date_id',
                ...
                'with' => array('BoxSize'),
//				'condition'=>'status='.UserBox::STATUS_APPROVED,
            ...
            'Locations' => array(self::MANY_MANY, 'Location', SnapUtil::config('boxomatic/tablePrefix') . 'delivery_date_locations(delivery_date_id,location_id)')
        );
    }
    ...
    {
        return SnapFormat::dayOfYear($this->date);
    }
