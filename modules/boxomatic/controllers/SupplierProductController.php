...
class SupplierProductController extends BoxomaticController
{
	/**
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['SupplierProduct']))
		{
			...
			if($model->save()) {
				$this->redirect(Yii::app()->user->getReturnUrl($this->createUrl('supplierProduct/index')));
			}
		}
	...
	{
		$dataProvider=new CActiveDataProvider('SupplierProduct');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='supplier-item-form')
		{
