<?php
	$this->menu=array(
		...
		array('label'=>'Update UserPayment', 'url'=>array('update', 'id'=>$model->payment_id)),
		array('label'=>'Login as Customer', 'url'=>array('user/LoginAs', 'id'=>$model->Customer->User->id)),
		array('label'=>'Delete UserPayment', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->payment_id),'confirm'=>'Are you sure you want to delete this item?')),
