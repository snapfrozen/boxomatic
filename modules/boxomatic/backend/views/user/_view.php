<div class="large-4 columns">
	<div class="panel">
		<ul class='no-bullet'>
			...
			<li><?php echo CHtml::encode($data->getAttributeLabel('user_id')); ?> : <?php echo CHtml::encode($data->user_id); ?></li>
			<li><?php echo CHtml::encode($data->getAttributeLabel('supplier_id')); ?> : <?php echo CHtml::encode($data->supplier_id); ?></li>
			<li><?php echo CHtml::encode($data->getAttributeLabel('email')); ?> : <?php echo CHtml::encode($data->email); ?></li>
