<div class="row">
	<div class="large-8 columns">
		...
		<form name= "order" action="https://www.paypal.com/cgi-bin/webscr" method="post">
			<fieldset>
				...
				<input type="hidden" name="custom" value="<?php echo $User->Customer->user_id ?>" />
	...
	<div class="large-4 columns">
		...
		<p>Your <?php echo Yii::app()->name ?> ID is: <?php echo $User->bfb_id ?>.<br />Cash: In person on at Bellingen Greengrocers.</p>
	</div>
</div>
