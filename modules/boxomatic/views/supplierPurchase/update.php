...
$this->breadcrumbs=array(
	...
	'Purchases'=>array('supplierPurchase/admin'),
	'Update',
);
$this->page_heading = 'Update Purchase';
$this->page_heading_subtext = 'for '.$model->Supplier->name;
$this->menu = array(
...
?>
<?php echo $this->renderPartial('_form', array('model'=>$model, 'SupplierProduct' => $SupplierProduct)); ?>