...
<?php $form=$this->beginWidget('application.widgets.SnapActiveForm', array(
	...
	<div class="col-lg-9 clearfix">
		...
		<?php echo $form->dropDownListControlGroup($model,'supplier_product_id',
				$model->supplierProduct ? SupplierProduct::getDropdownListItems($model->supplierProduct->supplier_id) : array(),array(
					'class'=>'chosen'
		)); ?>
